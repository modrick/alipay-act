...
module.exports = {
  ...
  verifyContent: function (content, sign, publicKey) {
    ...
    verifySign.update(content, 'utf8')
    return verifySign.verify(publicKey, sign, 'base64')
  },

  verifyContent2: function (content, sign, publicKey) {
  ...
  getSign: function (content, privateKey) {
     ...
     * @returns {String}
     */
  getSign2: function (content, privateKey) {
     ...
     * @returns {String}
     */
  getSignMD5: function (content, privateKey) {
    var md5 = crypto.createHmac('md5', privateKey)
